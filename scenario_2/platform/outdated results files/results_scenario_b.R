...
# 2.2.1 B) Bonferroni correction
{
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_1_1_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%
  set.seed(123)
  rejection_1_2_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%
  set.seed(123)
  rejection_1_3_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%
  set.seed(123)
  rejection_1_4_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_2_1_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%
  set.seed(123)
  rejection_2_2_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%
  set.seed(123)
  rejection_2_3_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%
  set.seed(123)
  rejection_2_4_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_3_1_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_3_2_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_3_3_bonf_B <- rejection_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_3_4_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_4_1_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_4_2_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_4_3_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_4_4_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_5_1_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_5_2_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_5_3_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_5_4_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_6_1_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_6_2_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_6_3_bonf_B <- rejection_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_6_4_bonf_B <- rejection_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_7_1_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_7_2_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_7_3_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_7_4_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_8_1_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_8_2_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_8_3_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_8_4_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Δ = 10%, baseline response rate of 10%:
  set.seed(123)
  rejection_9_1_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 266,
                                    alpha = 0.025,
  ...
  # Δ = 10%, baseline response rate of 30%:
  set.seed(123)
  rejection_9_2_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 477,
                                    alpha = 0.025,
  ...
  # Δ = 20%, baseline response rate of 10%:
  set.seed(123)
  rejection_9_3_bonf_B <- rejection_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Δ = 20%, baseline response rate of 30%:
  set.seed(123)
  rejection_9_4_bonf_B <- rejection_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
...
# 2.2.1 C) LOND 
{
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_1_1_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%
  set.seed(123)
  rejection_1_2_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%
  set.seed(123)
  rejection_1_3_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%
  set.seed(123)
  rejection_1_4_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_2_1_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%
  set.seed(123)
  rejection_2_2_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%
  set.seed(123)
  rejection_2_3_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%
  set.seed(123)
  rejection_2_4_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_3_1_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_3_2_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_3_3_lond_B <- rejection_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_3_4_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_4_1_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_4_2_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_4_3_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_4_4_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_5_1_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_5_2_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_5_3_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_5_4_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_6_1_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_6_2_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_6_3_lond_B <- rejection_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_6_4_lond_B <- rejection_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_7_1_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_7_2_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_7_3_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_7_4_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 10%:
  set.seed(123)
  rejection_8_1_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 10% and with baseline response 30%:
  set.seed(123)
  rejection_8_2_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  rejection_8_3_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  rejection_8_4_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Δ = 10%, baseline response rate of 10%:
  set.seed(123)
  rejection_9_1_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 266,
                                         alpha = 0.025,
  ...
  # Δ = 10%, baseline response rate of 30%:
  set.seed(123)
  rejection_9_2_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 477,
                                         alpha = 0.025,
  ...
  # Δ = 20%, baseline response rate of 10%:
  set.seed(123)
  rejection_9_3_lond_B <- rejection_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Δ = 20%, baseline response rate of 30%:
  set.seed(123)
  rejection_9_4_lond_B <- rejection_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
...
# 2.2.2 B) Bonferroni correction
{
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_2_3_bonf_B <- discovery_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_2_4_bonf_B <- discovery_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_3_3_bonf_B <- discovery_rate(treat_response_A = 0.1,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_3_4_bonf_B <- discovery_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.5,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_4_3_bonf_B <- discovery_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_4_4_bonf_B <- discovery_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_5_3_bonf_B <- discovery_rate(treat_response_A = 0.2,
                                    treat_response_B = 0.2,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_5_4_bonf_B <- discovery_rate(treat_response_A = 0.4,
                                    treat_response_B = 0.4,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_7_3_bonf_B <- discovery_rate(treat_response_A = 0.3,
                                    treat_response_B = 0.1,
                                    baseline_response = 0.1,
                                    n_arm = 82,
                                    alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_7_4_bonf_B <- discovery_rate(treat_response_A = 0.5,
                                    treat_response_B = 0.3,
                                    baseline_response = 0.3,
                                    n_arm = 124,
                                    alpha = 0.025,
...
# 2.2.2 C) LOND
{
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_2_3_lond_B <- discovery_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_2_4_lond_B <- discovery_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_3_3_lond_B <- discovery_rate(treat_response_A = 0.1,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_3_4_lond_B <- discovery_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.5,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_4_3_lond_B <- discovery_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_4_4_lond_B <- discovery_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_5_3_lond_B <- discovery_rate(treat_response_A = 0.2,
                                         treat_response_B = 0.2,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_5_4_lond_B <- discovery_rate(treat_response_A = 0.4,
                                         treat_response_B = 0.4,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 10%:
  set.seed(123)
  discovery_7_3_lond_B <- discovery_rate(treat_response_A = 0.3,
                                         treat_response_B = 0.1,
                                         baseline_response = 0.1,
                                         n_arm = 82,
                                         alpha = 0.025,
  ...
  # Powered to Δ = 20% and with baseline response 30%:
  set.seed(123)
  discovery_7_4_lond_B <- discovery_rate(treat_response_A = 0.5,
                                         treat_response_B = 0.3,
                                         baseline_response = 0.3,
                                         n_arm = 124,
                                         alpha = 0.025,
