...
# n = 266
set.seed(123)
successful_pt_trials(delta = 0, n_arm = 266, 
...
# n = 477
set.seed(123) 
successful_pt_trials(delta = 0, n_arm = 477, # delta1 = 0
...
# n = 82
set.seed(123) 
successful_pt_trials(delta = 0, n_arm = 82, # delta1 = 0
                     iterations = 100000, alpha = 0.025, baseline_response = 0.1, 
                     treat_response = 0.1 # same as baseline for no effect
)
...
# n = 124
set.seed(123) 
successful_pt_trials(delta = 0, n_arm = 124, # delta1 = 0
                     iterations = 100000, alpha = 0.025, baseline_response = 0.3, 
                     treat_response = 0.3 # same as baseline for no effect
)
...
set.seed(123) 
a<-successful_pt_trials(delta = 0.2-0.1, n_arm = 266, # delta1 = 0.1
...
set.seed(123) 
b<-successful_pt_trials(delta = 0.4-0.3, n_arm = 477, # delta1 = 0
...
set.seed(123) 
c<-successful_pt_trials(delta = 0.3-0.1, n_arm = 82, 
...
set.seed(123) 
d<-successful_pt_trials(delta = 0.5-0.3, n_arm = 124, 
