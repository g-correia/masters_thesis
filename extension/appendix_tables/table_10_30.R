...

{
  ...
  for(j in 1:settings_a){
    df[2,5 + j*3 -3] <- unname(rejection_1_2[[j]][1]) # A
    df[2,5 + j*3 -2] <- unname(rejection_1_2[[j]][2]) # B
    df[2,5 + j*3 -1] <- unname(discovery_1_2[[j]][1]) # FDR
  }
  ...
  ##############
  for(j in 1:settings_a){
    df[3,5 + j*3 -3] <- unname(rejection_2_2[[j]][1]) # A
    df[3,5 + j*3 -2] <- unname(rejection_2_2[[j]][2]) # B
    df[3,5 + j*3 -1] <- unname(discovery_2_2[[j]][1]) # FDR
  }
  ...
  (df[4,4] <- two_trial_3_2[[4]][1]) # B
  
  ##############
  # Scenario A #
  ##############
  for(j in 1:settings_a){
    df[4,5 + j*3 -3] <- unname(rejection_3_2[[j]][1]) # A
    df[4,5 + j*3 -2] <- unname(rejection_3_2[[j]][2]) # B
    df[4,5 + j*3 -1] <- unname(discovery_3_2[[j]][1]) # FDR
  }
  ...
  ##############
  for(j in 1:settings_a){
    df[5,5 + j*3 -3] <- unname(rejection_4_2[[j]][1]) # A
    df[5,5 + j*3 -2] <- unname(rejection_4_2[[j]][2]) # B
    df[5,5 + j*3 -1] <- unname(discovery_4_2[[j]][1]) # FDR
  }
  ...
  (df[6,4] <- two_trial_5_2[[4]][1]) # B
  
  ##############
  # Scenario A #
  ##############
  for(j in 1:settings_a){
    df[6,5 + j*3 -3] <- unname(rejection_5_2[[j]][1]) # A
    df[6,5 + j*3 -2] <- unname(rejection_5_2[[j]][2]) # B
    df[6,5 + j*3 -1] <- unname(discovery_5_2[[j]][1]) # FDR
  }
  ...
  ##############
  for(j in 1:settings_a){
    df[7,5 + j*3 -3] <- unname(rejection_6_2[[j]][1]) # A
    df[7,5 + j*3 -2] <- unname(rejection_6_2[[j]][2]) # B
    df[7,5 + j*3 -1] <- unname(discovery_6_2[[j]][1]) # FDR
  }
  ...
  ##############
  for(j in 1:settings_a){
    df[8,5 + j*3 -3] <- unname(rejection_7_2[[j]][1]) # A
    df[8,5 + j*3 -2] <- unname(rejection_7_2[[j]][2]) # B
    df[8,5 + j*3 -1] <- unname(discovery_7_2[[j]][1]) # FDR
  }
  ...
  (df[9,4] <- two_trial_8_2[[4]][1]) # B
  
  ##############
  # Scenario A #
  ##############
  for(j in 1:settings_a){
    df[9,5 + j*3 -3] <- unname(rejection_8_2[[j]][1]) # A
    df[9,5 + j*3 -2] <- unname(rejection_8_2[[j]][2]) # B
    df[9,5 + j*3 -1] <- unname(discovery_8_2[[j]][1]) # FDR
  }
  ...
  (df[10,4] <- two_trial_9_2[[4]][1]) # B
  
  ##############
  # Scenario A #
  ##############
  for(j in 1:settings_a){
    df[10,5 + j*3 -3] <- unname(rejection_9_2[[j]][1]) # A
    df[10,5 + j*3 -2] <- unname(rejection_9_2[[j]][2]) # B
    df[10,5 + j*3 -1] <- unname(discovery_9_2[[j]][1]) # FDR
  }
